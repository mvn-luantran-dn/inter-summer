...
! function (e, t) {
      ...
      createElement: function (e, t) {
        ...
        if (Array.isArray(e)) {
          if (n = document.createElement(e[0]), e[1].id && (n.id = e[1].id), e[1].classname && (n.className = e[1].classname), e[1].attr) {
            var i = e[1].attr;
            if (Array.isArray(i))
              for (var s = -1; ++s < i.length;) n.setAttribute(i[s].name, i[s].value);
      ...
      fade: function (e, t, n, i) {
        ...
        var s, r, o = null,
          ...
          u = function (d) {
            o || (e.publish(l, {
              target: t
            }), o = d), "in" === i ? (s = +t.style.opacity + (d - o) / n, a = s >= 1) : (s = +t.style.opacity - (d - o) / n, a = s <= 0), t.style.opacity = s, a ? e.publish(c, {
              target: t
  ...
  w.prototype.createPicker = function () {
    for (var e, t, n = this.Base.options, i = w.picker.indexOf(w.replace.hour_list), s = w.picker.indexOf(w.replace.minute_list), r = w.picker.indexOf(w.replace.hour_title), o = w.picker.indexOf(w.replace.minute_title), a = [], l = [], c = 0, u = 6, d = 0; d < 4; d++) {
    ...
    }, h.style.visibility = "", h.style.display = "none", h
  }, w.replace = {
    hour_list: "__hour-list__",
    minute_list: "__minute-list__",
    hour_title: "__hour-title__",
    minute_title: "__minute-title__"
  }, w.picker = ['<div class="' + _.header + '">', '<div class="' + _.hour + '">', w.replace.hour_title, "</div>", '<div class="' + _.minute + '">', w.replace.minute_title, "</div>", "</div>", '<div class="' + _.body + '">', '<div id="' + g.ids.hour_list + '" class="' + _.hour + '">', w.replace.hour_list, "</div>", '<div id="' + g.ids.minute_list + '" class="' + _.minute + '">', w.replace.minute_list, "</div>", "</div>"];
  var E = function (e) {
      var t, n, i, s, r, o, a = e.container.element,
        l = {},
        c = function (e) {
          e.preventDefault && e.preventDefault(), i = parseInt(a.style.left, 10) || 0, s = parseInt(a.style.top, 10) || 0, r = i + (e.clientX - t), o = s + (e.clientY - n), l.move.call(void 0, {
            target: a,
            x: r,
            y: o
        ...
        u = function () {
          document.removeEventListener("mousemove", c, !1), document.removeEventListener("mouseup", stop, !1), l.end.call(void 0, {
            target: a,
            x: r,
            y: o
          })
    ...
    b = function (e) {
      this.Base = e, this.container = e.container.element, this.closeWhen = {
        hour: !1,
        minute: !1
      }, this._ids = 0, this.id_active = void 0, this.opened = !1, this.targets = [], this.collection = {
        hours: [],
        minutes: []
      }, this.events = y.events(), this.request_ani_id = void 0
    };
  b.prototype.init = function () {
    ...
    var t = this.targets[e].element,
      ...
      s = n.top + n.height + 5,
      r = y.getWindowSize();
    n.left + i.width > r.width ? (this.container.style.left = "", this.container.style.right = "5px") : (this.container.style.right = "", this.container.style.left = n.left + "px"), n.top + i.height > r.height ? this.container.style.bottom = "5px" : this.container.style.top = s + "px", this.events.subscribe(m.start_fade_in, function (e) {
      e.target.style.opacity = 0, e.target.style.display = "block"
    }), this.request_ani_id = y.fade(this.events, this.container, 400), this.Base.dispatchEvent(m.open, {
      element: t
    }), this.handleOpen(e)
    ...
    this.opened = !1, this.events.subscribe(m.start_fade_out, function (e) {
      e.target.style.opacity = 1, e.target.style.display = "block"
    }), this.events.subscribe(m.end_fade_out, function (e) {
      e.target.style.display = "none"
    }), this.request_ani_id = y.fade(this.events, this.container, 800, "out"), this.Base.dispatchEvent(m.close, {
    ...
    y.removeClass(this.collection.hours, _.selected), y.removeClass(this.collection.minutes, _.selected), s && r && (this.collection.hours.forEach(function (e) {
      ...
      handleEvent: function (t) {
        if (!i.container.contains(t.target)) {
          ...
          }), !n && i.opened && i.hide(e), i.targets[e].element !== t.target && document.removeEventListener(t.type, this, !1)
        }
      }
    }, !1), this.opened = !0, this.id_active = e, this.closeWhen = {
      hour: !1,
      minute: !1
    }
    ...
    var e = this,
      ...
      i = function (t) {
        ...
        n.hour = e.getHour(t.target), e.Base.dispatchEvent(m.change, {
          element: n.element,
          hour: n.hour,
          minute: n.minute
        }), y.removeClass(e.collection.hours, _.selected), y.addClass(t.target, _.selected), e.closeWhen.hour = !0, e.handleClose(e.id_active)
      },
      s = function (t) {
        t.preventDefault();
        var n = e.targets[e.id_active];
        n.minute = e.getMinute(t.target), e.Base.dispatchEvent(m.change, {
          element: n.element,
          hour: n.hour,
          minute: n.minute
        }), y.removeClass(e.collection.minutes, _.selected), y.addClass(t.target, _.selected), e.closeWhen.minute = !0, e.handleClose(e.id_active)
      };
    this.collection.hours = y.getAllChildren(t, "a"), this.collection.minutes = y.getAllChildren(n, "a"), this.collection.hours.forEach(function (e) {
    ...
    var t, n = this,
      ...
      s = [];
    e = Array.isArray(e) ? e : [e], Array.prototype.push.apply(s, e), s.forEach(function (e) {
      if (t = y.evaluate(e)) {
        var s = n._ids++;
        t._id = s, n.targets[s] = {
          element: t
  ...
  var A = function (t) {
    function n(i, s) {
      void 0 === s && (s = {}), y.assert(Array.isArray(i) || "string" === y.typeOf(i) || y.isElement(i), "`target` should be Element, <Array>Element, String or <Array>String."), t.call(this), this.options = y.mergeOptions(p, s), this.target = i, this.container = {};
      var r = new w(this),
        o = r.createPicker(),
        a = new E(this);
      n.Internal = new b(this), n.Internal.init(), a.when({
        start: function () {
          y.addClass(o, e + c)
        },
        move: function (e) {
    ...
    return t && (n.__proto__ = t), n.prototype = Object.create(t && t.prototype), n.prototype.constructor = n, n.prototype.show = function () {
      n.Internal.show_()
